...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular HuRe",
    },
)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي تيبثون العرب الاصلي",
    },
)
async def nekobot(cat):
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular HuRe",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna HuRe is One of the Popular HuRe",
    },
)
async def nekobot(cat):
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; HuRe is One of the Popular HuRe",
    },
)
async def nekobot(cat):
