...
async def _(event):
    ...
    OUTPUT = f"**[تيبثون العرب](tg://need_update_for_some_feature/) الـمـلفـات:**\n{o}"
...
async def _(event):
    ...
    o = (await _catutils.runcmd(cmd))[0]
    OUTPUT = (
        f"**[تيبثون العرب](tg://need_update_for_some_feature/) قـائمـة الـفـارات:**\n\n\n{o}\n\n**انتبه هنالك معلومات حساسة لا تُعطِها لشخص غير موثوق**"
    )
