...
def main_menu():
    text = f"**- [سـورس تيبثون العرب](https://t.me/E9N99)\
        \n المسـاعد\
        \n\
        \n◽ تيبثون العرب لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" HuRe UsᴇʀBoᴛ", "https://t.me/E9N99"),
                )
            ]
            ...
            result = builder.article(
                title="رسـالة تـرول من سـورس تيبثون العرب 🧸♥",
            ...
            result = builder.article(
                title="همسـة سـرية من سـورس تيبثون العرب 🧸♥",
                text=f"فقـط {razan} هـو مـن يستـطيع مشـاهدتهـا !",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
            ...
            result = builder.article(
                title="رسـالة مخفيـة من سـورس تيبثون العرب 🧸♥",
                text=f"✖✖✖",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
        ...
        buttons = [
            (
                Button.url("قنـاة السـورس ⚒️", "https://t.me/E9N99"),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/jepthon1",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "**[بـوت تيبثون العرب 🧸♥](https://t.me/E9N99)**\
            \n\
            \n❤ تيبثون العرب هـو بـوت بسـيط يدخـل الـى حسـابك لجعـلك تتحـكم به معـ اوامـر معينـة.\
            \n\
